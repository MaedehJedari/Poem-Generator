...
function generatePoem(event) {
  ...
  let apiContext =
    "You are the best poet in the world who is an expert in writing quatrains. Write quatrains in basic HTML format and put a <br /> between each line and dont write any html or backticks. Sign the quatrain with `<br/><strong>SheCodes AI</strong>`";
